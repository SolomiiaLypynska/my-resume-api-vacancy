...
USING (
    SELECT 1 as VACANCY_ID, 3 as EMPLOYER_ID, 'Apple' as COMPANY_NAME, 'Java Developer' as POSITION_TITLE, 'Java, Spring' as REQUIREMENTS,
        ...
        700 as SALARY, 'Middle' POSITION_LEVEL, 1.5 as WORK_EXPERIENCE, 'PRODUCT' as COMPANY_TYPE, 'PRE_INTERMEDIATE' as ENGLISH_LEVEL FROM dual
        UNION ALL
    SELECT 2 as VACANCY_ID, 3 as EMPLOYER_ID, 'Apple' as COMPANY_NAME, 'JS Developer' as POSITION_TITLE, 'JS, HTML, CSS' as REQUIREMENTS,
        ...
        700 as SALARY, 'Middle' POSITION_LEVEL, 2 as WORK_EXPERIENCE, 'OUTSOURCE' as COMPANY_TYPE, 'PRE_INTERMEDIATE' as ENGLISH_LEVEL FROM dual
        UNION ALL
    ...
    SELECT 4 as VACANCY_ID, 3 as EMPLOYER_ID, 'Apple' as COMPANY_NAME, 'React Developer' as POSITION_TITLE, 'React.js, JS' as REQUIREMENTS,
        ...
        TO_DATE('2023-08-15 10:12:09', 'YYYY-MM-DD HH:mm:ss') as UPDATED_ON, 'PART_TIME' as EMPLOYMENT_TYPE,
        700 as SALARY, 'Middle' POSITION_LEVEL, 1.5 as WORK_EXPERIENCE, 'OUTSTAFF' as COMPANY_TYPE, 'BEGINNER_ELEMENTARY' as ENGLISH_LEVEL FROM dual
        UNION ALL
    SELECT 5 as VACANCY_ID, 3 as EMPLOYER_ID, 'Apple' as COMPANY_NAME, 'Devops' as POSITION_TITLE, 'Docker' as REQUIREMENTS,
        ...
        700 as SALARY, 'Middle' POSITION_LEVEL, 4 as WORK_EXPERIENCE, 'OUTSTAFF' as COMPANY_TYPE, 'ADVANCED_FLUENT' as ENGLISH_LEVEL FROM dual
        UNION ALL
    SELECT 6 as VACANCY_ID, 2 as EMPLOYER_ID, 'Google' as COMPANY_NAME, 'Devops' as POSITION_TITLE, 'Docker' as REQUIREMENTS,
        ...
        TO_DATE('2023-08-15 10:12:09', 'YYYY-MM-DD HH:mm:ss') as UPDATED_ON, 'SELF_EMPLOYED' as EMPLOYMENT_TYPE,
        700 as SALARY, 'Middle' POSITION_LEVEL, 2 as WORK_EXPERIENCE, 'OUTSOURCE' as COMPANY_TYPE, 'UPPER_INTERMEDIATE' as ENGLISH_LEVEL FROM dual
) res
