...
WHEN NOT MATCHED THEN
    ...
    EMPLOYMENT_TYPE, SALARY, POSITION_LEVEL, WORK_EXPERIENCE, COMPANY_TYPE, ENGLISH_LEVEL, LOCATION)
    VALUES (res.VACANCY_ID, res.EMPLOYER_ID, res.COMPANY_NAME, res.POSITION_TITLE, res.REQUIREMENTS, res.DESCRIPTION, res.ACTIVE,
        ...
        res.ENGLISH_LEVEL, res.LOCATION);